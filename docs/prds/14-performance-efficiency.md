...
5. **Implement content deduplication in FileStore** — Store files by SHA-256 hash. Check if hash exists before uploading. Maintain path→hash mapping in Postgres. Priority: medium.
